...
class Embedder():
    def __init__(self, obj, model_id: str = "nomic-ai/nomic-embed-text-v2-moe", fields: Sequence[str] = ("title","abstract"), overlap: int = 40):
    ...
    def to_str(self) -> str: #method converts DB entry to string first
        '''
    ...
    def str_to_vec(self, text: str, is_query: bool = False) -> np.ndarray:
        # Don't use prompt_name to match how documents were embedded
