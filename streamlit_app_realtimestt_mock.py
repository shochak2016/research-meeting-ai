...
# Add the mock PyAudio to the path
sys.path.insert(0, '/Users/pranaydayal/Desktop/researchai')

# Mock PyAudio before importing RealtimeSTT
import mock_pyaudio
...
st.markdown("Real-time speech-to-text transcription using RealtimeSTT (EXACT GitHub implementation with mock PyAudio)")
...
# Footer
st.markdown("---")
st.markdown("**RealtimeSTT Integration** - EXACT GitHub implementation with mock PyAudio")
